...
static bool checkm8_stage_patch(const usb_handle_t *handle) {
	...
	switch (cpid) {
		case 0x8000:
			LOG("setting up stage 2 for s8000");
			...
			break;
		case 0x8001:
			LOG("setting up stage 2 for s8001");
			...
			break;
		case 0x8003:
			LOG("setting up stage 2 for s8003");
			...
			break;
		case 0x7000:
			LOG("setting up stage 2 for t7000");
			...
			break;
		case 0x7001:
			LOG("setting up stage 2 for t7001");
			...
			break;
		case 0x8010:
			LOG("setting up stage 2 for t8010");
			...
			break;
		case 0x8011:
			LOG("setting up stage 2 for t8011");
			...
			break;
		case 0x8015:
			LOG("setting up stage 2 for t8015");
...
static bool gaster_checkm8(usb_handle_t *handle) {
	enum {
		STAGE_RESET,
		STAGE_SETUP,
		STAGE_SPRAY,
